...
optimizer = dict(type='AdamW', lr=1.4e-5, weight_decay=1e-3)
...
student_cfg = 'configs/distillers/retinanet_r50_reg_head.py'
teacher_cfg = 'configs/retinanet/retinanet_x101_64x4d_fpn_1x_coco.py'
work_dir = './work_dirs/final_wo_RAU'
gpu_ids = range(0, 1)
