...
from mmdet_addition.apis import train_detector,set_random_seed
from mmdet_addition.datasets import build_dataset
from mmdet.models import build_detector
from mmdet_addition.distillation import build_distiller
from mmdet.utils import collect_env, get_root_logger
from mmdet_addition.models import *
...
def main():
    ...
    if args.ckpt is not None:
        print(f"-----start to load ckpt{args.ckpt}--------")
